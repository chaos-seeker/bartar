  ...
  return (
    <section className="bg-white">
      <div className="container space-y-6 sm:space-y-10 lg:grid lg:grid-cols-2 lg:gap-10">
        <div className="bg-greyscale-10 relative h-[400px] overflow-hidden px-6 py-8 sm:h-[500px] sm:px-12 sm:py-10 lg:h-[600px] lg:px-16 lg:py-14">
          <div className="absolute top-8 left-6 z-30 inline-block bg-[#2C3E50] px-4 py-2 text-[10px] font-semibold tracking-[0.15em] text-white uppercase sm:top-10 sm:left-12 sm:px-5 sm:py-2.5 sm:text-xs lg:top-14 lg:left-16">
          ...
          <div className="relative z-20 flex h-full flex-col justify-between pt-14 sm:pt-16">
            <div className="max-w-lg space-y-3 sm:space-y-6">
              ...
              <p className="hidden max-w-sm text-base leading-relaxed text-gray-600 sm:block sm:text-[1.05rem] lg:text-base">
                from pro-level accessories to everyday must-haves.
              </p>
            </div>
            <Link
              href="/explore"
          ...
          <div className="absolute right-[30%] bottom-0 h-[350px] w-[350px] translate-y-[40%] rounded-full bg-gray-300 opacity-30 blur-[80px] sm:right-[35%] sm:h-[450px] sm:w-[450px] sm:blur-[120px]" />
          <div className="absolute right-0 bottom-0 h-full w-[60%] sm:w-[55%]">
            <Image
              src="/images/home/gadget.png"
              alt="Gadget"
              fill
